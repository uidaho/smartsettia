...
<head>
    ...
    <title>{{ $view_name }} - {{ config('app.name', 'SmartSettia') }}</title>
    ...
    <footer class="site-footer">
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-6 social-icons"><a href="#"><i class="fa fa-facebook"></i></a><a href="#"><i class="fa fa-twitter"></i></a><a href="/dashboard.html"><i class="fa fa-instagram" href="/dashboard.html"></i></a></div>
            </div>
        </div>
    </footer>
